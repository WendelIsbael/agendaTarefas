<x-layout title="">
    ...
    <div class="container">
        ...
        <div class="row mt-5" >
            ...
            <div class="col-4">
                <div class="container p-3 rounded-3" style="background-color: #7735A9">
            ...
            <div class="col-8">
                @csrf
                <div class="container p-3" style="background-color: #7735A9">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$id->descricao}}</td>
                                <td>
                                    <a href="/editar/{{$id->id}}" class="btn btn-primary">
